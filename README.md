...
Методы:
- getBasketCost — отображает итоговую стоимость заказа
- getBasketCardList — отображает список товаров в корзине
...
- order:change — обрабатывает данные ведённые в полях формы
...
- contact:change — обрабатывает данные ведённые в полях формы
- contact:error — отображение текста с ошибкой, при незаполненном поле

- success:open — открытие модального окна с успешным оформлением заказа
